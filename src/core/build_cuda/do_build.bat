...
set "TORCH_DIR=C:\Users\Gilles Colling\.pyenv\pyenv-win\versions\3.14.4\Lib\site-packages\torch\share\cmake\Torch"
set "PYTHON_EXE=C:\Users\Gilles Colling\.pyenv\pyenv-win\versions\3.14.4\python.exe"
...
set "MSVC_INC=C:\Program Files\Microsoft Visual Studio\18\Community\VC\Tools\MSVC\14.50.35717\include"
